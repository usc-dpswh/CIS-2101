...
//			LL* LLtrav;
//			hashval = hashOD(mainVH->elem[*trav].student.studentID)
//			for (LLtrav = &mainOD->headers[hashVal] ; *LLtrav != NULL ; LLtrav = &(*LLtrav)->next){};
//			LL newStudent = (LL)malloc(sizeof(struct node));
//			if (newStudent != NULL){
//				newStudent->student = mainVH->elem[*trav].student;
//				newStudent->next = NULL;
//				LLtrav = newStudent;
//				printf("\nInserted [%s]", newStudent->student.studentID);
//			}
		}
	} else {
		printf("\nelse 188");
